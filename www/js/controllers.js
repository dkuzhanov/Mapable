...
.controller("MapController", [ '$scope', '$log', '$http', 'leafletData', function($scope, $log, $http, leafletData) {
	...
	var markers = {
		...
		m3: {lat: 31.85, lng: -97.05, message: "I'm a static marker at 90 degrees", icon: icons.mountain, layer: "northTaiwan", focus: false, label: {	message: "Buff Mountain (1987)", options: {	noHide: true}}},
