...
function geojsonvt(data) {
   //Setting variables
    ...
    return new GeoJSONVT(data, tileOptions);
...
GeoJSONVT.prototype.options = {
    maxZoom: 9,            // max zoom to preserve detail on
    indexMaxZoom: 0,        // max zoom in the tile index
    indexMaxPoints: 10,  // max number of points per tile in the tile index
